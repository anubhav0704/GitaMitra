...
export const MobileNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-[#faf6ee]/95 dark:bg-[#0c091a]/95 backdrop-blur-xl border-t border-amber-500/20 px-3 py-1.5 flex items-center justify-around select-none safe-area-pb"
    >
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span className="font-serif text-[10px] mt-0.5">{item.label}</span>
          </Link>
        );
      })}
    </nav>
