...
export default function ProfileModal({ isOpen, onClose, user: propUser, onLogout: propLogout }: ProfileModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-lg max-h-[90vh] flex flex-col bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-all transform scale-100"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Scrollable Container with Banner and Body in same flow to avoid clipping */}
        <div className="flex-1 overflow-y-auto relative scrollbar-thin">
          {/* Header background banner */}
          <div className="h-28 bg-gradient-to-r from-amber-500 via-amber-600 to-amber-700 relative p-4 flex justify-between items-start">
          ...
          <div className="px-6 pb-6 relative">
            {/* Avatar badge overlapping banner - cleanly rendered without clipping */}
            <div className="-mt-14 mb-4 flex justify-between items-end relative z-10">
              <div className="relative group">
                <div className="w-24 h-24 rounded-2xl bg-white dark:bg-gray-800 p-1.5 shadow-2xl ring-4 ring-white dark:ring-gray-900 overflow-hidden">
                  {currentUser?.avatar_url ? (
                    ...
                    <div className="w-full h-full rounded-xl bg-gradient-to-tr from-amber-600 to-amber-500 text-white font-serif font-bold text-3xl flex items-center justify-center shadow-inner select-none">
                      {initial}
                    </div>
                  )}
                ...
                <label
                  ...
                  className="absolute -bottom-1 -right-1 p-1.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-white shadow-lg cursor-pointer transition-all hover:scale-110 active:scale-95 flex items-center justify-center border-2 border-white dark:border-gray-900"
                ...
                {currentUser?.avatar_url && (
                  <button
                    ...
                    className="absolute -top-1 -right-1 p-1 rounded-full bg-rose-600 hover:bg-rose-500 text-white shadow-md cursor-pointer transition-all hover:scale-110 border-2 border-white dark:border-gray-900"
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center space-x-1 font-medium">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            <div className="p-3 rounded-2xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-900/50">
              <div className="flex items-center space-x-1.5 text-sm text-amber-800 dark:text-amber-300 font-semibold">
            ...
            <div className="p-3 rounded-2xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center space-x-1.5 text-sm text-gray-600 dark:text-gray-300 font-semibold">
          ...
          <div className="mt-4 space-y-2">
            ...
            <Link
              href="/settings"
              onClick={onClose}
              className="flex items-center justify-between p-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-100 dark:border-gray-800 text-sm font-semibold text-gray-700 dark:text-gray-300 transition-colors"
            >
              <div className="flex items-center space-x-2.5">
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-100 dark:border-gray-800 text-sm font-semibold text-gray-700 dark:text-gray-300 transition-colors cursor-pointer"
            >
              <div className="flex items-center space-x-2.5">
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3.5 rounded-xl hover:bg-amber-50 dark:hover:bg-amber-950/30 border border-amber-200/80 dark:border-amber-900/50 text-sm font-semibold text-gray-700 dark:text-gray-300 transition-colors cursor-pointer group"
            >
              <div className="flex items-center space-x-2.5">
                {isExportingPdf ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3.5 rounded-xl hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-rose-100 dark:border-rose-900/50 text-sm font-semibold text-rose-600 transition-colors cursor-pointer"
            >
              <div className="flex items-center space-x-2.5">
          ...
          <div className="mt-5 pt-4 border-t border-gray-200 dark:border-gray-800 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors cursor-pointer"
            >
