...
async def run_evaluation():
    ...
    dataset_candidates = [
        os.path.join(parent_dir, "data", "evaluation", "memory_questions.json"),
        os.path.join(parent_dir, "backend", "data", "evaluation", "memory_questions.json"),
        os.path.join("/app", "data", "evaluation", "memory_questions.json"),
        os.path.join(current_dir, "..", "data", "evaluation", "memory_questions.json"),
    ]
    ...
    if not dataset_path:
        raise FileNotFoundError(f"Could not find memory_questions.json in {dataset_candidates}")
